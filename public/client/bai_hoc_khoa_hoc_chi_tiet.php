                ...
                <div class="modal-content">
                    <div class="modal-content-body">
                        ...
                        <div class="modal-study__suggest">
                            ...
                            if (count($listDaHocChuaBoQua) > 0) { //Danh sách từ đã chưa bị bỏ qua
                            ?>
                        ...
                        if (count($danhSachTuVungChuaHoc) == 0) { //Không có từ vựng nào cần học mới
                            ?>
                                <div class="modal-study__choose-function-wrap">
                            ...
                            <?php
                            } else { //Không thỏa mãn 2 điều kiện trên
                            ?>
                                <div class="modal-study__choose-function-wrap">
